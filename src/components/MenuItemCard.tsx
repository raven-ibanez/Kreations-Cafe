            ...
            <div className="flex-shrink-0">
              {!item.available ? (
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-coffee-brown to-coffee-espresso text-white px-6 py-2.5 rounded-xl hover:from-coffee-espresso hover:to-coffee-charcoal transition-all duration-200 transform hover:scale-105 font-medium text-sm shadow-lg hover:shadow-xl"
                >
                  {item.variations?.length || item.addOns?.length ? 'Customize' : 'Add to Cart'}
                </button>
              ) : (
                <div className="flex items-center space-x-2 bg-gradient-to-r from-coffee-cream to-coffee-beige rounded-xl p-1 border border-coffee-latte">
                  <button
                    onClick={handleDecrement}
                    className="p-2 hover:bg-coffee-latte rounded-lg transition-colors duration-200 hover:scale-110"
                  >
