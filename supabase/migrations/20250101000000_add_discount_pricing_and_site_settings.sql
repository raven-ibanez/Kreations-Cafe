...
INSERT INTO site_settings (id, value, type, description) VALUES
  ('site_name', 'Kreations Cafe', 'text', 'The name of the cafe/restaurant'),
  ...
  ('site_description', 'Welcome to Kreations Cafe - Artisan Coffee, Creative Creations', 'text', 'Short description of the cafe'),
